 ...
 *   morphologyTags: ['RNA', 'Single-stranded', 'ssRNA', 'Enveloped'],
...
export const MICROORGANISMS: MicroorganismCard[] = [
  ...
  defineCard({
    ...
    morphologyTags: ['DNA', 'Double-stranded', 'dsDNA', 'Enveloped'],
  ...
  defineCard({
    ...
    transmissionDirect: ['Lg Droplet', 'Sex'],
    transmissionIndirect: [],
    morphologyTags: ['DNA', 'Double-stranded', 'dsDNA', 'Naked'],
    ...
    virulenceFactors: 'Discuss with TA (E6 binds p53, E7 binds Rb tumor suppressors)',
  ...
  defineCard({
    ...
    morphologyTags: ['RNA', 'Single-stranded', 'ssRNA', 'Naked'],
  ...
  defineCard({
    ...
    virulenceFactors: 'CPS, LPS, fimbrae, iron stealing siderophore',
    prevention: 'Avoid infected animals, keep up to date on vaccinations',
  ...
  defineCard({
    ...
    morphologyTags: ['Gram-neg', 'Double-stranded', 'dsDNA', 'Enveloped'],
  ...
  defineCard({
    ...
    virulenceFactors: 'Pertussis AB exotoxin, filamentous hemagglutinin and fimbrae (aid in binding to cell), Adenylate cyclase toxin (membrane damaging toxin), tracheal cytotoxin (part of peptidoglycan of bacteria)',
    ...
    hasVaccine: true,
    notes: 'Tracheal cytotoxin destroys ciliated epithelial cells, preventing mucous clearance and provoking violent whoops.',
    highYieldBuzzwords: [
  ...
  defineCard({
    ...
    morphologyTags: ['Gram-pos', 'Double-stranded', 'dsDNA'],
  ...
  defineCard({
    ...
    virulenceFactors: 'Capsule (glycolax), can produce membrane damaging toxin when they die (pneumolysin)',
  ...
  defineCard({
    ...
    transmissionDirect: ['Lg Droplet'],
    transmissionIndirect: ['Droplet nuclei'],
    morphologyTags: ['Double-stranded', 'dsDNA'],
